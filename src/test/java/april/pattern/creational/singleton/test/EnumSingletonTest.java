...
import april.pattern.creational.singleton.register.EnumSingleton;
...
public class EnumSingletonTest {
    ...
    public static void main(String[] args) {
        ...
        try {
             ...
             *     }
             */
            // 下面会抛出java.lang.NoSuchMethodException: april.pattern.creational.singleton.register.EnumSingleton.<init>()
